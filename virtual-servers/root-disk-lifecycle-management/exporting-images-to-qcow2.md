...
**Overview:** We will spin up a [shared filesystem](../../docs/coreweave-kubernetes/storage/#shared-filesystem) to store a QCOW2 image, generated by a worker pod from a mounted PVC in our namespace.
...
Creating a [shared filesystem](../../docs/coreweave-kubernetes/storage/#shared-filesystem) gives us a destination for our worker pod to write to, as well as a volume that can be attached to a Virtual Server or Samba Pod to egress the exported QCOW2 file.
