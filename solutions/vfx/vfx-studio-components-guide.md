...
![Storage Options](<../../.gitbook/assets/image (66) (1).png>) ![Deployment](<../../.gitbook/assets/image (58).png>) ![Success](<../../docs/.gitbook/assets/image (104).png>)
...
![samba-ad options](../../docs/.gitbook/assets/SharedScreenshot.jpg) ![samba options](../../docs/.gitbook/assets/SharedScreenshot\).jpg) ![](<../../docs/.gitbook/assets/image (95).png>) ![Success! For those following along, your applications landing page should look similar.](<../../docs/.gitbook/assets/image (152).png>)

#### Connecting to Samba (WIN)

![Find the DNS name for the samba.](<../../.gitbook/assets/image (73) (1).png>)
...
![Success!!](<../../docs/.gitbook/assets/image (102).png>)
...
![After pressing Media Shuttle](<../../docs/.gitbook/assets/image (131).png>)
...
![Attaching our render-output PVC created in the reference namespace, and providing a custom name for the mount point.](<../../.gitbook/assets/image (83) (1).png>)
