...
<figure><img src="../docs/.gitbook/assets/image (1) (8).png" alt="The Cloud UI API Access page"><figcaption><p>The Cloud UI API Access page</p></figcaption></figure>
...
<figure><img src="../docs/.gitbook/assets/image (2) (1) (1).png" alt="Create a new access token dialog box"><figcaption><p><strong>Create a new access token</strong> dialog box</p></figcaption></figure>
