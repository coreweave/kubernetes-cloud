...
<figure><img src="../docs/.gitbook/assets/image (2) (1) (3) (1).png" alt="Create a new access token dialog box"><figcaption><p><strong>Create a new access token</strong> dialog box</p></figcaption></figure>
