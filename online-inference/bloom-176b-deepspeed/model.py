...
def get_downloaded_model_path(model_name: str):
    # InferenceService mounts pvc write-only so we can't use snapshot_download
    f = '/mnt/models/hub/models--microsoft--bloom-deepspeed-inference-fp16/snapshots/348b3ad25bb6871500ae0c659893acaec0468b16/'
    return f
#    f = partial(
#        snapshot_download,
#        repo_id=model_name,
