...
![The Argo Workflows configuration screen](<../docs/.gitbook/assets/image (1) (3).png>)
...
![The Argo Workflow UI with a Bearer token pasted into the client authentication box](<../docs/.gitbook/assets/image (5) (1).png>)
