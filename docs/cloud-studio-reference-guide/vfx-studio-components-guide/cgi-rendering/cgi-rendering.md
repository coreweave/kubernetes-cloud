...
This portion of the example assumes that you've already set up [Argo CLI tools](../../../machine-learning-and-ai/training/argo-workflows/argo.md) on CoreWeave Cloud.
{% endhint %}
