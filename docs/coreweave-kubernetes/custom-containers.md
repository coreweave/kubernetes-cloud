...
<figure><img src="../.gitbook/assets/image (10).png" alt="Screenshot: A FileBrowser instance named after the application to which it will be associated"><figcaption><p>A FileBrowser instance named after the application to which it will be associated</p></figcaption></figure>
