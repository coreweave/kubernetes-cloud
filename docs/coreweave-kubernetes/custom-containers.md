...
<figure><img src="../.gitbook/assets/image (19) (4).png" alt=""><figcaption><p>In this example, a storage volume with the name <code>kobold-ai</code> is created</p></figcaption></figure>
