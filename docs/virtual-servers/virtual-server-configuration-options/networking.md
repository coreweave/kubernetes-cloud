...
!["Attach IP" option in the Cloud UI.](<../../.gitbook/assets/image (2) (1) (1) (1) (1).png>)
...
<figure><img src="../../.gitbook/assets/image (4) (2).png" alt="The networking.vpcs stanza in the Cloud UI YAML manifest editor"><figcaption><p>The <code>networking.vpcs</code> stanza in the Cloud UI YAML manifest editor</p></figcaption></figure>
