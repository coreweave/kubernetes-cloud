...
!["Attach IP" option in the Cloud UI.](<../../.gitbook/assets/image (3) (3).png>)
...
<figure><img src="../../.gitbook/assets/image (15).png" alt="The networking.vpcs stanza in the Cloud UI YAML manifest editor"><figcaption><p>The <code>networking.vpcs</code> stanza in the Cloud UI YAML manifest editor</p></figcaption></figure>
