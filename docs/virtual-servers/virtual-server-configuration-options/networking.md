...
!["Attach IP" option in the Cloud UI.](<../../.gitbook/assets/image (3).png>)
...
![The floatingIPs option in the YAML manifest.](<../../.gitbook/assets/image (7).png>)
...
| ------------------------------------ | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `network.floatingIPs`                | \[]                                                                | A list of service references to be added as floating IPs. [_Learn more about Floating IPs_](https://app.gitbook.com/o/-M8EEYiNkaJsT8ISX0kX/s/-M83TghsCfsi8FCYs2DZ/\~/changes/wNljIln2hYUH3k2W4Ohi/virtual-servers/virtual-server-configuration-options/additional-features#floating-ips)_._ |
