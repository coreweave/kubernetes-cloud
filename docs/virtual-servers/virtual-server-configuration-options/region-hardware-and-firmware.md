...
{% tab title="CLI" %}
**Deployment method:** <mark style="background-color:green;">Kubernetes CLI</mark>\ <mark style="background-color:green;"></mark>\ <mark style="background-color:green;"></mark>Selecting a region for your Virtual Server is simple using the **Kubernetes manifest file**.
...
<mark style="background-color:orange;"></mark>\ <mark style="background-color:orange;"></mark>The data center region for the Virtual Server can be defined in the `vs_region` variable in your `variables.tf` file.\
...
![Screenshot of the resources.definition field.](<../../.gitbook/assets/image (49) (1).png>)
...
| Variable name   | Variable type | Description                                                                                                                                                                                                                           | Default value     |
| --------------- | ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `vs_cpu_count`  | Integer       | <p>Number of CPUs requested.</p><p><strong></strong><span data-gb-custom-inline data-tag="emoji" data-code="26a0">⚠</span> <strong>This option cannot be used if <code>vs_gpu_enable</code> is set to <code>true</code>.</strong></p> | `3`               |
...
{% tabs %}
{% tab title="Cloud UI" %}
**Deployment method:** <mark style="background-color:blue;">CoreWeave Cloud UI</mark>\ <mark style="background-color:blue;"></mark>\ <mark style="background-color:blue;"></mark>Firmware options must be set in the YAML tab from the Cloud UI. Firmware options are not currently exposed through the YAML manifest by default, so they must be added to the key-value map in the manifest.\
****\
**Example**\
****
...
<mark style="background-color:green;"></mark>\ <mark style="background-color:green;"></mark>**Example**
