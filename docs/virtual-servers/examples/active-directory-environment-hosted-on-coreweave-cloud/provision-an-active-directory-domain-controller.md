...
{% hint style="success" %}
Be sure to review [Getting Started](../../../coreweave-kubernetes/getting-started/#obtain-access-credentials) and the [kubectl Virtual Server deployment method](../../deployment-methods/kubectl.md#deploying-a-virtual-server) before starting this guide.
{% endhint %}
...
![Group Policy update](<../../../.gitbook/assets/image (12) (2) (1) (1).png>)
