...
| Regional label | Speedtest files                                                                                          |
| -------------- | -------------------------------------------------------------------------------------------------------- |
...
<figure><img src=".gitbook/assets/image (9) (2).png" alt="Data region selectors on CoreWeave Cloud UI"><figcaption><p>Data region selectors on CoreWeave Cloud UI</p></figcaption></figure>
