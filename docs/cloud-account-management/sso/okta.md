...
<figure><img src="../../.gitbook/assets/image (2).png" alt=""><figcaption><p>The "View SAML setup instructions" button is on the right-hand side of the SAML configuration screen</p></figcaption></figure>

This will redirect to a "How to" page, which contains all values for these fields.

<figure><img src="../../.gitbook/assets/image (14) (1) (2).png" alt="Screenshot of Okta setup"><figcaption></figcaption></figure>
