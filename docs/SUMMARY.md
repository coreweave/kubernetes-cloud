...
* [NVIDIA HGX H100](machine-learning-and-ai/nvidia-hgx-h100.md)
* [Inference](machine-learning-and-ai/inference/README.md)
  ...
  * [Examples and Tutorials](machine-learning-and-ai/inference/examples/README.md)
    ...
    * [PyTorch](machine-learning-and-ai/inference/examples/pytorch/README.md)
      * [Hugging Face](machine-learning-and-ai/inference/examples/pytorch/hugging-face/README.md)
        * [Stable Diffusion: Text to Image](machine-learning-and-ai/inference/examples/pytorch/hugging-face/pytorch-hugging-face-diffusers-stable-diffusion-text-to-image.md)
        * [Transformers Accelerate: BigScience BLOOM](machine-learning-and-ai/inference/examples/pytorch/hugging-face/pytorch-hugging-face-transformers-bigscience-bloom.md)
        * [Transformers DeepSpeed: BigScience BLOOM](machine-learning-and-ai/inference/examples/pytorch/hugging-face/pytorch-hugging-face-transformers-bigscience-bloom-1.md)
      * [GPT-2 for AITextgen](machine-learning-and-ai/inference/examples/pytorch/custom-pytorch-aitextgen.md)
      * [FastAI Sentiment](machine-learning-and-ai/inference/examples/pytorch/custom-sentiment.md)
...
* [Training](machine-learning-and-ai/training/README.md)
  ...
  * [Determined AI](machine-learning-and-ai/training/determined-ai/README.md)
    * [Install Determined AI](machine-learning-and-ai/training/determined-ai/install-determined-ai.md)
    ...
    * [Finetune GPT-NeoX 20B using DeterminedAI](machine-learning-and-ai/training/determined-ai/gpt-neox.md)
    * [Launch GPT DeepSpeed Models using DeterminedAI](machine-learning-and-ai/training/determined-ai/launch-gpt-deepspeed-models-using-determinedai.md)
    * [Custom Images for Determined AI](machine-learning-and-ai/training/determined-ai/custom-images-for-determined-ai/README.md)
      * [Finetune HuggingFace LLMs with Determined AI and DeepSpeed](machine-learning-and-ai/training/determined-ai/custom-images-for-determined-ai/finetuning-huggingface-llms-with-determined-ai-and-deepspeed.md)
  * [Kubeflow Training Operators](machine-learning-and-ai/training/kubeflow-training-operators/README.md)
    * [Finetune Stable Diffusion Models with CoreWeave](machine-learning-and-ai/training/kubeflow-training-operators/finetuning-image-generation-models.md)
    * [Finetune GPT-NeoX-20B with Argo Workflows](machine-learning-and-ai/training/kubeflow-training-operators/finetune-gpt-neox-20b-with-argo-workflows/README.md)
      * [JAX](machine-learning-and-ai/training/kubeflow-training-operators/finetune-gpt-neox-20b-with-argo-workflows/jax/README.md)
        * [DALL-E Mega](machine-learning-and-ai/training/kubeflow-training-operators/finetune-gpt-neox-20b-with-argo-workflows/jax/jax-dall-e-mini-mega.md)
      * [Custom](machine-learning-and-ai/training/kubeflow-training-operators/finetune-gpt-neox-20b-with-argo-workflows/custom/README.md)
        * [BASNET](machine-learning-and-ai/training/kubeflow-training-operators/finetune-gpt-neox-20b-with-argo-workflows/custom/custom-basnet.md)
    * [Train ResNet-50 with ImageNet](machine-learning-and-ai/training/kubeflow-training-operators/train-resnet-50-with-imagenet.md)
    * [Finetune GPT Models with CoreWeave](machine-learning-and-ai/training/kubeflow-training-operators/finetuning-machine-learning-models.md)
