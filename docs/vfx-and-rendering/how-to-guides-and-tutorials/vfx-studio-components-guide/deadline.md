...
First, [log in to your CoreWeave Cloud dashboard](https://cloud.coreweave.com), then navigate to [the Applications Catalog](../../../coreweave-kubernetes/applications-catalog.md) from the menu on the left.
