...
<figure><img src="../../.gitbook/assets/image (12) (3).png" alt="The Jupyter-lab homescreen"><figcaption><p>The Jupyter-lab homescreen</p></figcaption></figure>

To shut down the notebook, navigate to the **File** menu, then select **Shut Down**.

![The file -> shutdown menu](<../../.gitbook/assets/image (11) (4).png>)
