...
![Storage Options](<../../.gitbook/assets/image (84).png>) ![Deployment](<../../.gitbook/assets/image (61).png>) ![Success](<../../.gitbook/assets/image (104).png>)
...
![](<../../.gitbook/assets/image (128).png>) ![](<../../.gitbook/assets/image (133).png>)
...
![samba-ad options](../../.gitbook/assets/SharedScreenshot.jpg) ![samba options](../../.gitbook/assets/SharedScreenshot\).jpg) ![](<../../.gitbook/assets/image (95).png>) ![Success! For those following along, your applications landing page should look similar.](<../../.gitbook/assets/image (152).png>)

#### Connecting to Samba (WIN)

![Find the DNS name for the samba.](<../../.gitbook/assets/image (116).png>)

In order to connect. Map the network drive.

![](<../../.gitbook/assets/image (93).png>)

![Enter the DNS name and press Browse...](<../../.gitbook/assets/image (139).png>)

![Press the drop down to find the mount name easily.](<../../.gitbook/assets/image (79).png>)

Select the mount, press ok, and enter credentials.

![Success!!](<../../.gitbook/assets/image (102).png>)
...
![After pressing the checkbox the registration key will be available to copy](<../../.gitbook/assets/image (117).png>)
...
![Attaching our render-output PVC created in the reference namespace, and providing a custom name for the mount point.](<../../.gitbook/assets/image (151).png>)

![Landing page updated!](<../../.gitbook/assets/image (150).png>)
