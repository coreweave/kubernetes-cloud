...
![](<../../.gitbook/assets/image (30).png>)![](<../../.gitbook/assets/image (33).png>)
...
![samba-ad options](../../.gitbook/assets/SharedScreenshot.jpg) ![samba options](../../.gitbook/assets/SharedScreenshot\).jpg) ![](<../../.gitbook/assets/image (14).png>) ![Success! For those following along, your applications landing page should look similar.](<../../.gitbook/assets/image (39).png>)

#### Connecting to Samba (WIN)

![Find the DNS name for the samba.](<../../.gitbook/assets/image (24).png>)

In order to connect. Map the network drive.&#x20;

![](<../../.gitbook/assets/image (12).png>)

![Enter the DNS name and press Browse...](<../../.gitbook/assets/image (35).png>)

![Press the drop down to find the mount name easily. ](<../../.gitbook/assets/image (7).png>)

Select the mount, press ok, and enter credentials.

![Success!!](<../../.gitbook/assets/image (18).png>)
...
![After pressing the checkbox the registration key will be available to copy ](<../../.gitbook/assets/image (25).png>)



![After pressing Media Shuttle](<../../.gitbook/assets/image (32).png>)
...
![Attaching our render-output PVC created in the reference namespace, and providing a custom name for the mount point.](<../../.gitbook/assets/image (38).png>)

![Landing page updated!](<../../.gitbook/assets/image (37).png>)
...
![YAML tab to attach storage](<../../.gitbook/assets/image (1).png>)
