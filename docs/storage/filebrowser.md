...
To deploy FileBrowser, first log in to your CoreWeave Cloud account. Then, navigate to [the Applications Catalog](../coreweave-kubernetes/coreweave-cloud-ui/applications-catalog.md). Once in the Catalog, use the search bar to search for `filebrowser`.
