...
* [Determined AI is installed in your namespace](../determined-ai-guides/install-determined-ai.md), including installation prerequisites:
  * [FileBrowser](../determined-ai-guides/install-determined-ai.md#install-filebrowser) is installed
  * A [shared filesystem volume](../determined-ai-guides/install-determined-ai.md#create-a-shared-filesystem-volume) with an easily-recognizable name, such as `finetune-gpt-neox`, is created
  * An [Object Storage bucket](../determined-ai-guides/install-determined-ai.md#create-an-object-storage-bucket) with an easily-recognizable name, such as `model-checkpoints`, is created

The values used for this demo's [shared filesystem volume](../determined-ai-guides/install-determined-ai.md#create-a-shared-filesystem-volume) are as follows:
...
When [installing Determined AI](../determined-ai-guides/install-determined-ai.md), ensure that the newly-created filesystem volume for this demo is attached. From the bottom of the application configuration screen, click `+` to attach the `finetune-opt-125m` volume.
